              ...
              <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      <label>Date</label>
                      <input type="text" name="date" id="date" class="form-control form-control-sm datepicker form-control-sm" placeholder="YYYY-MM-DD" readonly>
                    </div>
                    <div class="form-group col-md-4">
     ...
     $(document).ready(function(){
       $('#valideform').validate({
        ...
        messages:{
          ...
          purchase_no:{
            required:"Please enter purchase no",
          },
          supplier_id:{
