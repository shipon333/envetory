      ...
      <div class="col-md-12">
        ...
        <table border="1" width="100%" style="text-align: center;">
              ...
              <tbody>
                  ...
                  @php
                    $buying_total = App\Model\Purchases::where('category_id',$product->category_id)->where('product_id',$product->id)->where('status','1')->sum('buying_qty');
